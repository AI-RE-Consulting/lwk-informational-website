        ...
        <div className="section-container">
          <div className="flex items-center justify-between h-20">
            ...
            <a href="#" className="flex-shrink-0 flex flex-col items-start leading-none">
              ...
              <span className="flex w-full justify-between text-white font-serif text-[0.6rem] font-semibold mt-0.5">{header.logoLine2.split('').map((ch: string, i: number) => <span key={i}>{ch}</span>)}</span>
            </a>
