...
export default function PressCard({ article, index }: PressCardProps) {
  return (
    <motion.a
      ...
      className="group flex-shrink-0 w-[340px] md:w-[380px] bg-navy-700/50 border border-white/10 rounded-sm p-8 hover:bg-navy-700/80 hover:-translate-y-1 hover:shadow-xl transition-all duration-300 block snap-center sm:snap-start"
    >
